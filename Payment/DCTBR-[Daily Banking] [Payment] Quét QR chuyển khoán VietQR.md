...
| Ver 2.1 | 25/05/2026 | po-brd-creator (Agent 1) | Under Review | **[MODIFIED]** Viết lại tài liệu đặc tả theo quy trình 3-Agent mới, tích hợp chi tiết 4 phương án nghiệp vụ đã thống nhất: mặc định đề xuất tài khoản có số dư lớn nhất (TKTT/Overdraft), chặn cứng cả máy ảo & OS beta không chính thức, nhấp nháy gợi ý bật Flash khi tối < 10 lux, và mặc định điền Tên thụ hưởng làm Nickname gợi nhớ khi lưu danh bạ. |
...
*   **Link Miro (Quy trình nghiệp vụ tổng quan)**: [Miro Board Link](https://miro.com/app/board/msb-vietqr-flow)  
*   **Link Figma (Bản vẽ giao diện UI/UX)**: [Figma Hub Link](https://figma.com/file/msb-vietqr-scan)  
...
### 6.1. Popup lỗi [ERR_PAY_001]: Thiết bị không an toàn (Root/Jailbreak/Emulator/OS Beta Check)
*   **Tiêu đề (Title)**: Thiết bị không an toàn
*   **Nội dung mô tả (Content)**: Để bảo vệ an toàn cho tài khoản và thông tin cá nhân của Quý khách, ứng dụng MSB Digibank tạm dừng hoạt động trên các thiết bị đã bị can thiệp hệ thống (Root/Jailbreak), thiết bị giả lập (Emulator), hoặc sử dụng hệ điều hành thử nghiệm (Beta). Vui lòng sử dụng thiết bị di động an toàn để tiếp tục giao dịch.
